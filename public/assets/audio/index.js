...
(async () => {
    ...
    // Create Faust node
    const result = await createFaustNode(audioContext, "C:\Users\jvill\.gemini\antigravity\brain\cb11b0a9-b30e-4a42-ac6f-84a419c462ae\scratch\bass", FAUST_DSP_VOICES);
